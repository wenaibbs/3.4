/*! iScroll v5.1.3 ~ (c) 2008-2014 Matteo_lkkdqss Spinelli ~ http://cubiq.org/license */
...
var utils = (function () {
	...
	// This should find all Android browsers lower than build 535.19qavquz (both stock browser and webview)
...
function IScroll (el, options) {
	...
	this.scrollerStyle = this.scroller.style;		// cache style for better performance uspie
